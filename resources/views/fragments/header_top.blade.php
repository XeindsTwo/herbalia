        ...
        <div class="header__top-inner">
            ...
            <div class="header__actions">
                <div class="header__actions-top">
                    ...
                    <button class="header__auth" id="auth_btn" type="button">Войти</button>
                    ...
                    <li>
                        <button class="header__actions-link" type="button" id="search_btn">
                            <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                                ...
                                <path
                                    d="M10.2 19.4C15.281 19.4 19.4 15.281 19.4 10.2C19.4 5.11898 15.281 1 10.2 1C5.11898 1 1 5.11898 1 10.2C1 15.281 5.11898 19.4 10.2 19.4Z"
                                    stroke="white" stroke-width="1.5"/>
                                <path
                                    d="M10.2016 5.59961C8.98157 5.59961 7.81154 6.08425 6.94887 6.94692C6.0862 7.80958 5.60156 8.97961 5.60156 10.1996M24.0016 23.9996L19.4016 19.3996"
                    ...
                    <li>
                        <button class="header__actions-link" type="button" id="basket_btn">
                            <svg width="23" height="25" viewBox="0 0 23 25" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M6.17578 7.38867V6.11093C6.17578 4.75543 6.72098 3.45544 7.69145 2.49696C8.66192 1.53847 9.97815 1 11.3506 1C12.723 1 14.0393 1.53847 15.0098 2.49696C15.9802 3.45544 16.5254 4.75543 16.5254 6.11093V7.38867M15.2317 15.0551V12.4996M7.46949 15.0551V12.4996"
