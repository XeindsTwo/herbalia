    ...
    <div class="container">
        <div class="footer__content">
            <nav class="footer__nav">
                <span class="footer__name">Для клиентов</span>
                <ul class="footer__list">
                    <li class="footer__item">
                        <a class="footer__link" href="{{ route('about') }}">О компании</a>
                    </li>
                    <li class="footer__item">
                    ...
                    <li class="footer__item">
                        <a class="footer__link" href="{{ route('payment') }}">Оплата</a>
                    </li>
                    <li class="footer__item">
                        <a class="footer__link" href="{{ route('delivery') }}">Доставка</a>
                    </li>
                    <li class="footer__item">
                        <a class="footer__link" href="{{ route('flower-care') }}">Уход за цветами</a>
                    </li>
                    <li class="footer__item">
                        <a class="footer__link" href="{{ route('guarantee') }}">Гарантии</a>
                    </li>
                    <li class="footer__item">
                        <a class="footer__link" href="{{ route('howOrder') }}">Как заказать</a>
                    </li>
                    <li class="footer__item">
                        <a class="footer__link" href="{{ route('faq') }}">Вопросы-ответ</a>
                    </li>
                    <li class="footer__item">
                        <a class="footer__link" href="">Бонусная программа</a>
                    </li>
                    <li class="footer__item">
                        <a class="footer__link" href="{{ route('agreement') }}">Пользовательское соглашение</a>
                    </li>
                    <li class="footer__item">
                        <a class="footer__link" href="{{route('corporate')}}">Корпоративным клиентам</a>
                    </li>
                    <li class="footer__item">
            ...
            <nav class="footer__nav">
                <span class="footer__name">Праздники</span>
                <ul class="footer__list">
                    <li class="footer__item">
                        <a class="footer__link" href="">14 февраля</a>
                    </li>
                    <li class="footer__item">
                        <a class="footer__link" href="">8 марта</a>
                    </li>
                    <li class="footer__item">
                        <a class="footer__link" href="">1 мая</a>
                    </li>
                    <li class="footer__item">
                        <a class="footer__link" href="">9 мая</a>
                    </li>
                    <li class="footer__item">
                        <a class="footer__link" href="">Последний звонок</a>
                    </li>
                    <li class="footer__item">
                        <a class="footer__link" href="">Выпускной</a>
                    </li>
                    <li class="footer__item">
                        <a class="footer__link" href="">День матери</a>
                    </li>
                    <li class="footer__item">
                        <a class="footer__link" href="">1 сентября</a>
                    </li>
                    <li class="footer__item">
                        <a class="footer__link" href="">День учителя</a>
                    </li>
                    <li class="footer__item">
                        <a class="footer__link" href="">Новый год</a>
                    </li>
                </ul>
            </nav>
        </div>
        <div class="footer__bottom">
            ...
            <div class="footer__bottom-links">
                ...
                <a class="footer__bottom-link" href="">Согласие на обработку персональных данных</a>
            </div>
            <ul class="footer__payments" role="list">
                <li class="footer__payments-item">
                    <svg class="icon icon--full-color" version="1.1" xmlns="http://www.w3.org/2000/svg" role="img" x="0"
                         ...
                         aria-labelledby="footer-pi-apple_pay"><title id="footer-pi-apple_pay">Apple Pay</title>
                        <path fill="#000"
                ...
                <li class="footer__payments-item">
                    <svg class="icon icon--full-color" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 38 24"
                         width="38" height="24" aria-labelledby="footer-pi-google_pay"><title id="footer-pi-google_pay">
                            Google Pay</title>
                ...
                <li class="footer__payments-item">
                    <svg class="icon icon--full-color" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" role="img"
                         width="38" height="24" aria-labelledby="footer-pi-master"><title id="footer-pi-master">
                            Mastercard</title>
                        <path opacity=".07"
                ...
                <li class="footer__payments-item">
                    <svg class="icon icon--full-color" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 38 24"
                         width="38" height="24" aria-labelledby="footer-pi-shopify_pay"><title
                                id="footer-pi-shopify_pay">Shop Pay</title>
                        <path opacity=".07"
                ...
                <li class="footer__payments-item">
                    <svg class="icon icon--full-color" viewBox="-36 25 38 24" xmlns="http://www.w3.org/2000/svg"
                         width="38" height="24" role="img" aria-labelledby="footer-pi-unionpay"><title
                                id="footer-pi-unionpay">Union Pay</title>
                        <path fill="#005B9A"
                ...
                <li class="footer__payments-item">
                    <svg class="icon icon--full-color" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" role="img"
                         width="38" height="24" aria-labelledby="footer-pi-visa"><title id="footer-pi-visa">Visa</title>
                        <path opacity=".07"
                              d="M35 0H3C1.3 0 0 1.3 0 3v18c0 1.7 1.4 3 3 3h32c1.7 0 3-1.3 3-3V3c0-1.7-1.4-3-3-3z"></path>
                        <path fill="#fff"
                              d="M35 1c1.1 0 2 .9 2 2v18c0 1.1-.9 2-2 2H3c-1.1 0-2-.9-2-2V3c0-1.1.9-2 2-2h32"></path>
